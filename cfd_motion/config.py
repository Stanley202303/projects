...
CFD_PRESETS = {
    "debug": {
        ...
        "MIN_COMPONENT_CELLS_ACROSS": "3",
        "MAX_ADAPTIVE_SURFACE_REFINEMENT": "7",
        "REGION_REFINEMENT": "2",
    ...
    "balanced": {
        ...
        "MIN_COMPONENT_CELLS_ACROSS": "3",
        "MAX_ADAPTIVE_SURFACE_REFINEMENT": "8",
        "REGION_REFINEMENT": "4",
    ...
    "accurate": {
        ...
        "SURFACE_REFINEMENT_MAX": "5",
        "MIN_COMPONENT_CELLS_ACROSS": "3",
        "MAX_ADAPTIVE_SURFACE_REFINEMENT": "9",
        "REGION_REFINEMENT": "5",
...
MIN_COMPONENT_CELLS_ACROSS = max(
    1.0,
    cfg_float("MIN_COMPONENT_CELLS_ACROSS", "2"),
)
MAX_ADAPTIVE_SURFACE_REFINEMENT = max(
    SURFACE_REFINEMENT[1],
    cfg_int("MAX_ADAPTIVE_SURFACE_REFINEMENT", "7"),
)
